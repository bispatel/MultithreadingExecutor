...
public class SchedulingTaskForFixedRateExecution {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		long interval = 2000;
		timer.scheduleAtFixedRate(new ScheduledTaskA(1000), scheduledTime, interval);
		...
		long interval2 = 2000;
		timer.scheduleAtFixedRate(new ScheduledTaskA(1000), delayMilliSec, interval2);
